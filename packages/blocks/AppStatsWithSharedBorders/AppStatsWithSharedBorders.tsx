...
interface AppStatsWithSharedBordersProps {
	title: any;
	items: Array<{
		label: any;
		value: any;
...
const AppStatsWithSharedBorders = ({
	title,
	items,
}: AppStatsWithSharedBordersProps): JSX.Element => {
...
export default AppStatsWithSharedBorders;
