...
interface VerticallyAlignedBlogCardOverlappedWithDescriptionBoxProps {
	title: any;
	subtitle: any;
	items: Array<{
		title: any;
...
const mock = [
	...
	},
	{
		...
		subtitle: "Qui blanditiis praesentium voluptatum deleniti atque corrupti",
...
const VerticallyAlignedBlogCardOverlappedWithDescriptionBox = ({
	title,
	subtitle,
}: VerticallyAlignedBlogCardOverlappedWithDescriptionBoxProps): JSX.Element => {
